...
def init_spark():
	sql=SparkSession.builder \
		.appName("trip-app") \
		.config("examples.jars", "/opt/examples-apps/postgresql-42.2.22.jar") \
		.getOrCreate()
	sc=sql.sparkContext
	return sql, sc
...
def main():
	...
	properties={
		...
		"examples.driver.extraClassPath":"/opt/examples-apps/postgresql-42.2.22.jar"
	}
	file="MTA-Bus-Time.2014-08-01.csv"
	sql, sc=init_spark()
